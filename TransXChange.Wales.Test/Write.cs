...
namespace TransXChange.Wales.Test
{
    ...
    public class Write
    {
        ...
        public void Agency()
        {
            ...
            Dictionary<string, TXCSchedule> schedules = travelineHelpers.ReadWales(stops, "Data/W.zip", Environment.GetEnvironmentVariable("KEY"), "bus", new[] { "all" }, new[] { "5710WDB48395" }, "14/08/2023", 7);
