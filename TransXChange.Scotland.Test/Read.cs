...
namespace TransXChange.Scotland.Test
{
    ...
    public class Read
    {
        ...
        public void Traveline()
        {
            ...
            Dictionary<string, NAPTANStop> stops = naptanHelpers.Read("Data/edinburgh.csv");
            Dictionary<string, TXCSchedule> schedules = travelineHelpers.ReadScotland(stops, "Data/S.zip", Environment.GetEnvironmentVariable("KEY"), "bus", new[] { "all" }, new[] { "6200206531" }, "14/08/2023", 7);
