...
namespace TransXChange.Scotland.Test
{
    ...
    public class Write
    {
        ...
        public void Agency()
        {
            ...
            Dictionary<string, TXCSchedule> schedules = travelineHelpers.ReadScotland(stops, "Data/S.zip", Environment.GetEnvironmentVariable("KEY"), "bus", new[] { "all" }, new[] { "6200206531" }, "13/11/2023", 7);
