    ...
    internal class Program
    {
        ...
        private void Run(COMMANDOption options)
        {
            ...
            try
            {
                ...
                Dictionary<string, TXCSchedule> originals = travelineHelpers.ReadScotland(stops, options.Traveline, options.Key, options.Mode, options.Indexes, options.Filters, options.Days);
