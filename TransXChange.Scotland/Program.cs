    ...
    internal class Program
    {
        ...
        private void Run(COMMANDOption options)
        {
            ...
            try
            {
                ...
                Dictionary<string, TXCSchedule> schedules = TransXChangeHelpers.ReadScotland(stops, options.TransXChange, options.Key, options.Mode, options.Indexes, options.Filters, options.Date, options.Days);
