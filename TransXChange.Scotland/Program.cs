    ...
    internal class Program
    {
        ...
        private void Run(COMMANDOption options)
        {
            ...
            try
            {
                ...
                Dictionary<string, TXCSchedule> schedules = TravelineHelpers.ReadScotland(stops, options.Traveline, options.Key, options.Mode, options.Indexes, options.Filters, options.Date, options.Days);
